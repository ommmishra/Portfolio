...
%  \position{Software Engineer{\enskip\cdotp\enskip}Security Expert}
 \address{Institute of Technical Education and Research, Bhubaneshwar}

\mobile{(+91) 8144478838}
\email{ommmishra830@gmail.com}
% \homepage{www.posquit0.com}
\github{ommmishra}
\linkedin{ommmishra}
% \gitlab{gitlab-id}
% \stackoverflow{ommmishra}{ommmishra}
% \twitter{@twit}
% \skype{skype-id}
% \reddit{reddit-id}
